...
mod bcs_tests {
    ...
    fn test_bcs_branch_taken() {
        ...
        // Set carry flag
        cpu.flags.c = 1;
        // BCS +2, NOP, NOP, LDA #$42, BRK
        let program = vec![0xB0, 0x02, 0xEA, 0xEA, 0xA9, 0x42, 0x00];
    ...
    fn test_bcs_branch_not_taken() {
        ...
        // Clear carry flag
        cpu.flags.c = 0;
        // BCS +3, LDA #$42, BRK, NOP, LDA #$24, BRK
        let program = vec![0xB0, 0x03, 0xA9, 0x42, 0x00, 0xEA, 0xA9, 0x24, 0x00];
        cpu.load_program(&program, 0x8000);
        cpu.endless_run();
    ...
    fn test_bcs_page_crossing() {
        ...
        // BCS +20 (crosses page boundary), BRK
        let program = vec![0xB0, 0x14, 0x00];
