...
pub(crate) fn lda_0xa9(cpu: &mut Cpu) -> u8 {
    ...
    trace_instruction!(cpu, "LDA", "0xA9", "Immediate");
    2
}
...
pub(crate) fn lda_0xa5(cpu: &mut Cpu) -> u8 {
    ...
    trace_instruction!(cpu, "LDA", "0xA5", "Zeropage");
    3
}
...
pub(crate) fn lda_0xb5(cpu: &mut Cpu) -> u8 {
    ...
    trace_instruction!(cpu, "LDA", "0xB5", "Zeropage,X");
    4
}
...
pub(crate) fn lda_0xad(cpu: &mut Cpu) -> u8 {
    ...
    trace_instruction!(cpu, "LDA", "0xAD", "Absolute");
    4
}
...
pub(crate) fn lda_0xbd(cpu: &mut Cpu) -> u8 {
    ...
    trace_instruction!(cpu, "LDA", "0xBD", "Absolute,X");
...
pub(crate) fn lda_0xb9(cpu: &mut Cpu) -> u8 {
    ...
    trace_instruction!(cpu, "LDA", "0xB9", "Absolute,Y");
    if page_crossed { 5 } else { 4 }
}
...
pub(crate) fn lda_0xa1(cpu: &mut Cpu) -> u8 {
    ...
    trace_instruction!(cpu, "LDA", "0xA1", "(Indirect,X)");
    6
}
...
pub(crate) fn lda_0xb1(cpu: &mut Cpu) -> u8 {
    ...
    trace_instruction!(cpu, "LDA", "0xB1", "(Indirect),Y");
